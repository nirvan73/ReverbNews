...
@Composable
fun FavouriteScreenNormalScreen(
    currentScreen: Screens,
    onNavigate: (Screens) -> Unit,
    windowSize: WindowWidthSizeClass,
) {
    val likedArticleViewModel: LikedArticleViewModel = hiltViewModel()
    val newsUiState = likedArticleViewModel.newsUiState.collectAsState().value
                    ...
                    Column(
                        ...
                        Surface(
                            ...
                            LikedArticleScreen(
                                ...
                                uiState = likedArticleViewModel.uiState,onLikeArticle = likedArticleViewModel::likeArticle,
